...
Sections:
  1. Network backend (tailscale or iap)
  2. GCP project and zone
  3. VM name, machine type, disk size
  4. Network-specific settings (Tailscale auth key, etc.)
  5. Toolchains and extra packages
EOF
}
